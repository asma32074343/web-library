...
foreach  ($searchresult as $c) {
	       ...
	       echo '<div class="divTableCell">'.$c->AutherName.'</div>';
				 	echo '<div class="divTableCell"><a href="'. base_url().'index.php/admin/editbook/'.$c->IsbnNnumber.'">editboo</a></div>';
          echo '<div class="divTableCell"><a href="delate/?IsbnNnumber'. $c->IsbnNnumber.'">delate</a></div>';
         	echo '</div>';
}
